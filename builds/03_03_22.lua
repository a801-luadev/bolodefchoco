...
local modeMetaInfo = {
	...
	["*\3evil rising"] = {
		name = "*\3evil rising",
		authors = { "Bolodefchoco#0015" },
		owners = { "Max#3652", "Cierne#0000", "Khchul#6543" },
		alias = {
			isTribeHouse = false,
			community = "en",
			modeName = "perguntas"
	...
	modules["main"] = function()
		...
		local setPublic = function()
			public = {
				...
				[5] = {
					color = "F0D3AD",
					name = "Public Event Squad members",
					list = _TEAM.evt
				},
				[6] = {
					color = "F3D165",
		...
		eventNewPlayer = function(playerName)
			...
			tfm.exec.chatMessage("<CEP>\t/c D_shades<font size='-3'><G>#0780</G></font> <font color='#7AC9C4'>,moduleteam</font>\n"
				...
				.."\t/c D_shades<font size='-3'><G>#0780</G></font> <font color='#2F7FCC'>,mapcrew</font>\n"
				.."\t/c D_shades<font size='-3'><G>#0780</G></font> <font color='#F0D3AD'>,eventsquad</font>\n"
				...
				.."\t/c D_shades<font size='-3'><G>#0780</G></font> <font color='#C2C2DA'>,flashsquad</font>\n"
				.."\t/c D_shades<font size='-3'><G>#0780</G></font> <font color='#546E78'>,bots</font>"
			, playerName)
			...
			local luaEventData = system.luaEventLaunchInterval()
		
			tfm.exec.chatMessage("<font color='#F0D3AD'>Ξ Lua events are loading in rooms every " .. luaEventData.interval .. " - " .. (luaEventData.interval + luaEventData.random).. " minutes!</font>", playerName)
			eventNewGame()
		end
		table.foreach(tfm.get.room.playerList, eventNewPlayer)
		
		eventPlayerLeft = function(playerName)
			tfm.exec.chatMessage("<N2>&lt; " .. playerName, "Bolodefchoco#0015")
		end
...
local roomModes = function(modeName)
	...
	modules["collapse"] = (modeName == "collapse") and function()
		tfm.exec.disableAutoNewGame()
		tfm.exec.disableAutoShaman()
		tfm.exec.disablePhysicalConsumables()
	...
	modules["flash"] = (modeName == "flash") and function()
		local objects = {
	...
	modules["micecraft"] = (modeName == "micecraft") and function()
		local modulo = {
				...
				if down then
					...
					elseif key == 71 then -- G
						if room.player[playerName].trade.isActive then 
							...
							ui.addPopup(10, 0, "<p align='center'>Tradings are disabled currently, sorry.</p>", playerName, 250, 180, 300, true)
						end
					end
				else
	...
	modules["miceditor"] = (modeName == "miceditor") and function()
	...
	modules["supa"] = (modeName == "supa") and function()
	...
	modules["tictactoe"] = (modeName == "tictactoe") and function()
		---------------------------
		-- Script: Tic Tac Toe
...
local tribeModes = function(modeName)
	...
	tribeModule["*\3Lost Heaven"] = (modeName == "*\3Lost Heaven") and function()
		-- map: @7744070
		shamanObjects = {}
		idlenessPlayers = {}
