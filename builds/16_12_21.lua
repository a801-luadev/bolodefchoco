	...
	modules["main"] = function()
		...
		local updateList = function(playerName)
			...
			for k = 1, #public do
				...
				Y = k % 2
				ui.addTextArea(-k, public[k].str, playerName, 5 + ((k - 1) % 3) * 400, 20 + Y * 200, 390, 190 - (Y * 15), -1, 1, 1, false)
		...
		tfm.exec.newGame('<C><P L="1200" /><Z><S><S c="4" L="1200" o="E0E0E" X="600" H="385" Y="207" T="12" P=",,,,,,," /><S L="1200" X="600" H="35" Y="380" T="6" P=",,.3,.2,,,," /><S L="10" X="-5" H="71" Y="335" T="12" P=",,,,,,," /><S L="10" H="71" X="1205" Y="335" T="12" P=",,,,,,," /></S><D><DS Y="360" X="350" /></D><O /></Z></C>')
