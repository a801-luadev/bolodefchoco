...
local modeMetaInfo = {
	...
	["*\3Lost Heaven"] = {
		name = "*\3Lost Heaven",
		authors = { "Keras#9975" },
		owners = { "Naomikio#0000", "Keras#9975", "Fireball#3838", "Sheogorath#8725", "Felixe96#0000","Kawaymixare#0000", "Missellik#5355", "Voimyasatani#6041", "Buterbrot#9081", "Floweystyle#8410", "Juzya#8075", "Istyb#0000" }
	}
	,
	...
	tribeModule["*\3Lost Heaven"] = (modeName == "*\3Lost Heaven") and function()
		...
		function firstBookClick(playerName)
		    ...
		    *Книга написана чем-то, напоминающим странную смесь крови, слёз и ядовитых испарений действующего вулкана.*
		    ...
		    ui.addPopup(1,0, text, playerName, 210, 50, 400,true)
		end
		...
		function secondBookClick(playerName)
		    ...
		    ui.addPopup(2002,0, text2, playerName, 110, 30, 600,true)
		    ui.addPopup(2001,0, text1, playerName, 110, 30, 600,true)
		    ui.addPopup(2000,0, text0, playerName, 110, 30, 600,true)
		end
		...
		function seventeenBookClick(playerName)
		    ...
		    ui.addPopup(1702,0, text2, playerName, 210, 50, 400,true)
		    ui.addPopup(1701,0, text1, playerName, 210, 50, 400,true)
		    ui.addPopup(1700,0, text0, playerName, 210, 50, 400,true)
		end
